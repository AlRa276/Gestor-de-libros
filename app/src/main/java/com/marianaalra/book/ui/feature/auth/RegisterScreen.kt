package com.marianaalra.book.ui.feature.auth
...
import com.marianaalra.book.ui.theme.VistaTheme // o el nombre real de tu tema
...
fun RegisterScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(text = "Regístrate para empezar a usar BookLog",
